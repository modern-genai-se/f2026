...
- Each student will lead one paper presentation and discussion session. Each paper session should last roughly 50 minutes, and has three parts: a 15-minute presentation, a 10-minute Reviewer's Card activity, and a 25-minute discussion.

- The rubric for session evaluation can be found here: [Rubric](rubric.md)

- **NOTE: You are responsible for sending the instructor your completed slide deck via email by noon on the Thursday before your session. Five points will be deducted from your presentation grade for each day the slides are late, up to a maximum of 20 points.**
- Name the subject line of your email "GenAI Seminar Slides – [first author] – [your presentation date]". For example: GenAI Seminar Slides – Butler – Sep 14.
...
**When nobody answers, wait.** Count silently to ten before rephrasing. Most presenters fill the silence after three seconds, which teaches the room that waiting works. If ten seconds pass, call on someone specific: "Group three, you said the sample was unrepresentative. Say more."

**Follow up before moving on.** When someone answers, ask a second question about their answer before going to the next item on your list. Cycling mechanically through prepared questions produces four short exchanges instead of one real conversation.

**When one person dominates,** say "let's hear from someone who hasn't spoken yet."

**When a thread stalls, move on.** Do not try to revive a question that is not working. This is why you prepared four and only need three.
